...
UP_THRESHOLD = thresholds["UP_THRESHOLD"] - 0.5
DOWN_THRESHOLD = thresholds["DOWN_THRESHOLD"] 

# ====== Blink → click settings ======
CLICK_COOLDOWN_SEC = 0.8
_last_click_ts = 0.0
...
LONG_BLINK_SEC = 1.0        # both eyes closed for this long → warp
...
def detect_gaze(eye_img, blink_confirmed, mesh_points, is_eye_closed):
